...
Object.defineProperty(exports, "__esModule", { value: true });
const TextDevice_1 = __webpack_require__(17);
module.exports = TextDevice_1.TextDevice;
...
const LAST_ENABLED_KEY = 'lastEnabled';
class TextDevice extends BaseDevice_1.default {
    onInit() {
    ...
    setText(text, updateOnlyIfChanged, refresh) {
        return __awaiter(this, void 0, void 0, function* () {
            if (updateOnlyIfChanged && this.lastText === text && this.lastEnabled) {
                return;
            }
            yield this.getClient().setText(this.screen, this.block, text);
            if (refresh) {
                yield this.refresh();
            }
            yield this.setEnabled(true);
            this.lastText = text;
            yield this.setStoreValue(LAST_TEXT_KEY, text);
        });
    }
}
__decorate([
    utils_1.Catch(true)
], TextDevice.prototype, "onInit", null);
exports.TextDevice = TextDevice;
